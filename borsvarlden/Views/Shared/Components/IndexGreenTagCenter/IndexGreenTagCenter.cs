...
{
    public class IndexGreenTagCenter : ViewComponent
    {
        private readonly IFinwireNewsService _finwireNewsService;
        private readonly IConfigurationHelper _configurationHelper;

        public IndexGreenTagCenter(IFinwireNewsService finwireNewsService, IConfigurationHelper configurationHelper)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var model = await _finwireNewsService.GetGreenTagNewsHighLighted(newsCount);
            ...
            return View("IndexGreenTagCenter", model);
        }
    }
}
